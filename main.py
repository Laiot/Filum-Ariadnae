...
def users():
    ...
    if request.method == 'GET':
        ...
        return render_template('users.html', user=user, users=users, register_user_form=register_form,
...
def store():
    ...
    survey = Survey(data.get('tag'), classtoken, type, data.get('path'), data.get('history'), data.get('gender'), age,
                    data.get('residence'), data.get('q1'), data.get('q2'), data.get('q3'), data.get('q4'),
                    data.get('q5'), data.get('q6'), data.get('q7'), data.get('q8'), data.get('q9'),
                    data.get('freetext'))
